  ...
  def run(self):
    ...
    for game in games:
      ...
      while timeout < (15 / 0.05): 
        ...
        graphics.DrawText(offscreen_canvas, font, x_pos, y_pos + 1, textColor, away_team_formatted)                                              
        graphics.DrawText(offscreen_canvas, font, ( offscreen_canvas.width - ( len(str(away_team_runs)) * 4 ) ), y_pos + 1, textColor, str(away_team_runs))
        graphics.DrawText(offscreen_canvas, font, x_pos, y_pos + 12, textColor, home_team_formatted)                                              
        graphics.DrawText(offscreen_canvas, font, ( offscreen_canvas.width - ( len(str(home_team_runs)) * 4 ) ), y_pos + 12, textColor, str(home_team_runs))
